 ...
 */
public abstract class JumbleObserver extends IJumbleObserver.Stub {
    public abstract void onConnecting() throws RemoteException;
    ...
    public abstract void onDisconnected(JumbleException e) throws RemoteException;
